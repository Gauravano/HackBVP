...
class PricesControllerTest < ActionController::TestCase
  ...
  test "should create price" do
    assert_difference('Price.count') do
      post :create, price: { category: @price.category, cost: @price.cost, userdetails_id: @price.userdetails_id }
    end
  ...
  test "should update price" do
    patch :update, id: @price, price: { category: @price.category, cost: @price.cost, userdetails_id: @price.userdetails_id }
    assert_redirected_to price_path(assigns(:price))
  end
